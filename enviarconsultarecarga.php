<?php
	...
	$mensaje .= "Utiliza cartuchos: " . $cartucho . " \r\n". "<br>";
	...
	$asunto = 'Consulta por reciclado de cartuchos - Enviada desde formulario web';
		...
		<body>
	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-xs-12  col-md-10 col-md-offset-1 lp-info-product bottom-20" id="resultado-solicitud-reciclado">
	                    <div class="row vertical-align">
	                        <div class="col-md-6 no-gutter">
	                            <img src="images/recycling-people.png" class="img-responsive center-block rounded-left-5">
	                        </div>

	                        <div class="col-md-6 text-center">
	                        	<h1>&#161;Perfecto&#33;</h1>
	                        	<h2>Ya enviaste tu consulta sobre reciclado</h2>
	                        	<br>
	                        	<p class="text-justify">
	                        		En breve te estaremos llamando para contarte si realizamos reciclados de &eacute;se cartucho y el valor. Mientras tanto, te invitamos a visitar nuestro sitio y conocer qu&eacute; m&aacute;s tenemos para ofrecerte.
	                        	</p>
