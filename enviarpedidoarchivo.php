<?php
	...
	$mensaje .= "Necesita que le enviemos " . $requerido . " para su equipo" . " \r\n". "<br>";
	...
	$asunto = 'Solicitud de archivos - Enviada desde formulario web';
		...
		<body>
	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-xs-12  col-md-10 col-md-offset-1 lp-info-product bottom-20" id="resultado-solicitud-descarga">
	                    <div class="row vertical-align">
	                        <div class="col-md-6 no-gutter">
	                            <img src="images/cloud-download.png" class="img-responsive center-block rounded-left-5">
	                        </div>
	                        ...
	                        <div class="col-md-6 text-center">
	                        	...
	                        	<p class="text-justify">
	                        		En breve te estaremos enviando el material que solicitaste. Mientras tanto, te invitamos a visitar nuestro sitio y conocer qu&eacute; m&aacute;s tenemos para ofrecerte.
	                        	</p>
