<?php
	...
	$para = 'soporte@todocopiasrl.com.ar';
	$asunto = 'Solicitud de soporte tecnico - Enviada desde formulario web';
		...
		<body>
	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-xs-12  col-md-10 col-md-offset-1 lp-info-product bottom-20" id="resultado-solicitud-soporte">
	                    <div class="row vertical-align">
	                        <div class="col-md-6 no-gutter">
	                            <img src="images/helping-robot.png" class="img-responsive center-block rounded-left-5">
	                        </div>

	                        <div class="col-md-6 text-center">
	                        	<h1>&#161;Perfecto&#33;</h1>
	                        	<h2>Ya enviaste tu solicitud de soporte</h2>
	                        	<br>
	                        	<p class="text-justify">
	                        		En breve te estaremos llamando para resolver tus dudas y ayudarte a explotar al m&aacute;ximo tu equipo. Mientras tanto, te invitamos a visitar nuestro sitio y conocer qu&eacute; m&aacute;s tenemos para ofrecerte.
	                        	</p>
