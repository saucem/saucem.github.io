<?php
	...
	$asunto = 'Solicitud de servicio en taller - Enviada desde formulario web';
		...
		<body>
	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-xs-12  col-md-10 col-md-offset-1 lp-info-product bottom-20" id="resultado-solicitud-taller">
	                    <div class="row vertical-align">
	                        <div class="col-md-6 no-gutter">
	                            <img src="images/camion-envio.png" class="img-responsive center-block rounded-left-5">
	                        </div>
	                        ...
	                        <div class="col-md-6 text-center">
	                        	...
	                        	<p class="text-justify">
	                        		En breve te estaremos llamando para coordinar el retiro. Mientras tanto, te invitamos a visitar nuestro sitio y conocer qu&eacute; m&aacute;s tenemos para ofrecerte.
	                        	</p>
